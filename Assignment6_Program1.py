...
def AskInput():
    ...
    FirstNum = int(input("1st input/number:  "))
    SecNum = int(input("2nd input/number:  "))
    ThirdNum = int(input("3rd input/number:  "))
    FourthNum = int(input("4th input/number:  "))
...
def Solve(FirstNumF, SecNumF, ThirdNumF, FourthNumF):
   ...
   # compare 1st and 2nd, compare 3rd and 4th. then compare higher1 to the higher2
    ...
    #compare highbutlow and lowbuthigh
